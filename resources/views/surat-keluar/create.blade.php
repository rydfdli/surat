        ...
        <form action="{{ route('surat-keluar.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('perihal') is-invalid @enderror" id="perihal" placeholder="Perihal" name="perihal" value="{{ old('perihal') }}">
                @error('perihal')
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('tujuan') is-invalid @enderror" id="tujuan" placeholder="Tujuan" name="tujuan" value="{{ old('tujuan') }}">
                @error('tujuan')
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control @error('tanggal_keluar') is-invalid @enderror" id="tgl-surat" placeholder="Tgl Surat" name="tanggal_keluar" value="{{ old('tanggal_surat') }}">
